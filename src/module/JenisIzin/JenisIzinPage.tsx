...
import { loadList, next, pagingTable, prev } from "@/module/redux/jenisIzinSlice";
import { useAppSelector, useAppDispatch } from "@/module/redux/hooks";
import { HandlerObserver } from "@/module/abstract/HandlerObserver";
import { jenisizinselector } from "@/module/redux/jenisIzinSlice";
import { DeleteJenisIzin } from "@/module/repo/DeleteJenisIzin";
