...
import { loadListJenisSPPD, sppdselector } from '@/module/redux/sppdSlice';
...
const NewSPPDPage = () => {
	...
	const formik = useFormik({
		...
		onSubmit: async (value: any) => {
			try {
				...
				const response: any = await CreateSPPD({
	...
	return (
		<PageWrapper name='SPPD'>
			<Subheader>
				<SubheaderLeft>
					<Breadcrumb currentPage='Tambah SPPD' />
				</SubheaderLeft>
			</Subheader>
			<Container>
