...
const ModalTambahIzin = () => {
    ...
    async function addIzin(izin:any){
        try {
            ...
            const response:any = await CreateIzin(izin);
    ...
    return ReactDOM.createPortal(
        ...
        document.getElementById('modal-tambah-izin')!
    );
};

export default ModalTambahIzin;
